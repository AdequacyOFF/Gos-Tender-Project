...
- **Agents** ([_gosplan-agents_](https://github.com/rexologue/gosplan-agents))
...
2. Ссылки на развернутые агенты:
    ...
    - [Агент для выбора заказов](https://a389c765-d595-4b20-9507-29c1deb52921-agent.ai-agent.inference.cloud.ru)
